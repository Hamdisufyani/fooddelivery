    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Column(
          ...
          return  _cartConroller.getCartHistoryList().isNotEmpty?  Expanded(
              child: Container(
          ...
          SizedBox(
            height: MediaQuery.of(context).size.height/1.5,
              child: const Center(child: NoDataPage(text: "Your didn't but anything so far !" ,imgPath: "assets/images/empty_box.jpg",)));
          })
          ],
        ),
      ),
